...
console.log(numbersExercise2.map(number => number * number));// another short way
...
console.log(wordsExercise4.map(word => `The length of  ${word} is: ${word.length}`));
...
console.log(booksExercise9.map(book =>`Book author: ${book.author} and book title: ${book.title}`));
