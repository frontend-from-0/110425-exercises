...
console.log(studentsExercise9.filter(student => goodGrades.includes(student.grade)));
...
console.log(usersExercise10.filter(user => user.name.toLowerCase().startsWith('J')))